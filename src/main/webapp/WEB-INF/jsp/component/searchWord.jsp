	...
	<div style="display: flex; flex-direction: row;">
		...
		<div style="flex: 1;">
			...
			<div style="display: flex;">
				...
				<div class='search_word_condition_value_wrapper less_width'>
					<div class="form-group">
						<input type="text" class="form-control" id="${param.idPrefix}query_content" placeholder="단어" autocomplete="off" />
					</div>
				</div>
			</div>
		</div>
...
/*          let sCondition = '';
  			...
  			<c:choose>
				<c:when test="${param.bListScreen == 'true'}">
					wordlist_jqGrid_url = 'word/list?' + jQuery.param(oSearchPayload);
				...
				<c:when test="${param.bListScreen == 'false'}">
					wordsearch_jqGrid_url = 'word/list_approved?' + jQuery.param(oSearchPayload);
